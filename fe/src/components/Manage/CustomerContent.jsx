  ...
  return (
    <div className="layout-content">
      ...
      <form className="d-flex mt-2" role="search" onSubmit={handleSearch}>
        ...
        />
        <button className="btn btn-success" type="submit"><FaSearch fontSize={14} style={{marginBottom: 2}} /> Tìm kiếm</button>
      ...
      <table className="table table-hover mt-3">
        <thead>
          <tr>
            ...
            <td><strong>Thêm gói tập mới</strong> </td> 
            ...
            filteredCustomers.map((customer, index) => {
              ...
              return (
                <tr key={customer._id}>
                  ...
                  <td><button className="btn btn-sm btn-outline-primary" onClick={() => handleOpenRegister(customer._id)}>
                      Đăng ký gói tập
                    </button></td>
                  <td>
                    <ActionButtons
