              ...
              <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                  <div className="carousel-item active">
                    <img src="/images/gym1.jpg" className="d-block w-100 image-slide-show" alt="Image 1"/>
                  </div>
                  <div className="carousel-item">
                    <img src="/images/gym2.jpg" className="d-block w-100 image-slide-show" alt="Image 2"/>
                  </div>
                  <div className="carousel-item">
                    <img src="/images/gym3.jpg" className="d-block w-100 image-slide-show"  alt="Image 3"/>
                  </div>
                </div>
