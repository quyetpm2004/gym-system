...
router.get(
    '/user/:userId',
    authMiddleware,
    workoutSessionController.getUserWorkoutSessions
);
...
router.get(
    ...
    authMiddleware,
    workoutSessionController.getUserWorkoutProgress
);
...
router.patch(
    '/:sessionId/confirm',
    authMiddleware,
    workoutSessionController.confirmWorkoutSession
);
...
router.get(
    '/pending',
    authMiddleware,
    workoutSessionController.getPendingWorkoutSessions
);
...
router.get(
    ...
    authMiddleware,
    workoutSessionController.getSessionsByMembership
);
...
router.patch(
    '/:sessionId/checkin',
    authMiddleware,
    workoutSessionController.checkInWorkoutSession
);
...
router.patch(
    '/:sessionId/checkout',
    authMiddleware,
    workoutSessionController.checkOutWorkoutSession
);
...
router.get(
    '/user/:userId/stats',
    authMiddleware,
    workoutSessionController.getWorkoutStats
);
